...
class Blockchain:
    ...
    def create_block(self, proof, previous_hash):
        """Simple create a block after it is sucesfully mined.
    ...
    def proof_of_work(self, previous_proof):
        ...
        In this case we are simply using some algebric function that uses the
    ...
    def hash_op(self, proof, previous_proof):
        ...
        """
        return sha256(str(proof**2 - previous_proof**2).encode()).hexdigest()
